...
const RefundPolicy = () => {
  ...
  return (
    <div className="text-white px-4 py-8 max-w-4xl mx-auto">
      ...
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold my-6 text-center font-serif">
        📌 Refund & Replacement Policy
      </h2>

      <h3 className="text-lg sm:text-xl font-semibold mt-4">1. Eligibility for Refunds</h3>
      ...
      <h3 className="text-lg sm:text-xl font-semibold mt-4">2. No Refunds in Certain Cases</h3>
      <ul className="list-disc pl-5 text-base sm:text-lg">
      ...
      <h3 className="text-lg sm:text-xl font-semibold mt-4">3. Revisions & Modifications</h3>
      ...
      <h3 className="text-lg sm:text-xl font-semibold mt-4">4. Contact for Refund Requests</h3>
      <p className="text-base sm:text-lg">
