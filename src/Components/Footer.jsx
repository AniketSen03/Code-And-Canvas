    ...
    <footer className="text-white py-6 mt-10">
      <div className="mx-auto px-6 flex flex-col md:flex-row justify-around items-start font-serif max-sm:text-sm max-sm:items-center max-sm:text-center">
        <ul>
          ...
          <li><Link to={'/faq'} className="hover:text-red-400 transition-all duration-200 ease-in">FAQ</Link></li>
          <li><Link to={'/reviews'} className="hover:text-red-400 transition-all duration-200 ease-in">Reviews</Link></li>
          <li><Link to={'/contact'} className="hover:text-red-400 transition-all duration-200 ease-in">Contact</Link></li>
          <li><Link to={'/achievements'} className="hover:text-red-400 transition-all duration-200 ease-in">Achievements</Link></li>
        </ul>
        <ul>
          <li className="font-bold text-red-500">Quick Links</li>
          <li><Link to={'/privacypolicy'} className="hover:text-red-400 transition-all duration-200 ease-in">Privacy Policy</Link></li>
          <li><Link to={'/terms&conditions'} className="hover:text-red-400 transition-all duration-200 ease-in">Terms & Conditions</Link></li>
          <li><Link to={'/refund&replacement'} className="hover:text-red-400 transition-all duration-200 ease-in">Refund & Replacment Policy</Link></li>
        </ul>
        <ul>
          <li className="font-bold text-red-500">Services</li>
          <li><Link to={'/services'} className="hover:text-red-400 transition-all duration-200 ease-in">Graphic Design</Link></li>
          <li><Link to={'/services'} className="hover:text-red-400 transition-all duration-200 ease-in">Web Development</Link></li>
          <li><Link to={'/services'} className="hover:text-red-400 transition-all duration-200 ease-in">UI/UX Design</Link></li>
        </ul>
        <ul>
      ...
      <div className="flex flex-wrap justify-around items-center max-sm:block">
        ...
        <div className="flex justify-center items-center space-x-4 mt-4 md:mt-0 max-sm:justify-evenly max-sm:ml-20">
          ...
          <a href="https://www.instagram.com/code_and_canva/" target="_blank" className="hover:text-red-500 transition-all duration-200 ease-in"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
          ...
          <a href="https://github.com/AniketSen03" target="_blank" className="hover:text-red-500 transition-all duration-200 ease-in"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
            <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27s1.36.09 2 .27c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8" />
          </svg></a>
          <a href="https://x.com/SenAniket15668" target="_blank" className="hover:text-red-500 transition-all duration-200 ease-in"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
